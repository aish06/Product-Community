...
public class QuestionController 
{
	...
	public ResponseEntity<?> raiseQuestion(@RequestParam("userEmail") String userEmail, @RequestBody Question question) throws ParseException
	{
		User loggedInUser;
		try
		{
	...
	public ResponseEntity<JSONArray> searchQuestions( @Or({
        ...
        @Spec(path = "createdDate", params = "searchText", spec =Like.class),
}) Specification<Question> spec)
	{
		JSONArray searchResult = questionService.listToJsonArray(questionService.getQuestionsBySearchParameters(spec));
		System.out.println(searchResult);
	...
	public ResponseEntity<?> likeQuestion(@RequestParam("userEmail") String userEmail,@RequestParam("questionId") int questionId)
	{
